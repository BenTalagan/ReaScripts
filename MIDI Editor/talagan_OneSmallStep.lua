...
function SettingsPanel()
  if reaper.ImGui_BeginTabBar(ctx, 'settings_tab_bar', reaper.ImGui_TabBarFlags_None()) then
    ...
    if reaper.ImGui_BeginTabItem(ctx, 'Editing') then
      ...
      SettingComboBox("InsertModeInMiddleOfMatchingNotesBehaviour",     "  · if a pressed note matches, then",  "TOOLTIP", 220)
      SettingComboBox("InsertModeInMiddleOfNonMatchingNotesBehaviour", "  · if no pressed note matches, then", "TOOLTIP", 220)
